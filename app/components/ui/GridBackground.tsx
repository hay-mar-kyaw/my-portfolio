                ...
                <div className="max-w-sm mt-10">
                    ...
                    <div className="flex gap-4 mt-24">
                        ...
                        <div className="absolute flex px-1 py-0.5 justify-start items-center inset-0">
                            ...
                            ></div>
                            <div
                            className="rounded-full shrink-0 flex justify-center items-center  h-full aspect-square bg-[#1A3D64] text-white transition-all duration-1000 ease-[cubic-bezier(0.510,0.026,0.368,1.016)] group-hover:bg-black"
                            >
                            <div
                                className="size-[0.8rem] text-white group-hover:text-white group-hover:-rotate-45 transition-all duration-1000 ease-[cubic-bezier(0.510,0.026,0.368,1.016)]"
                            >
                                <svg
